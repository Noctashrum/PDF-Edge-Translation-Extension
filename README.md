...
2. 打开左下角 **开发人员模式**；
3. 点 **加载解压缩的扩展**，选择本项目的 `extension` 目录（或把 `dist/pdf-huaci-translator-1.1.0.zip` 解压后选那个目录）；
...
| 选不全就改，或一键扩选 | 缩略图侧栏 | 网页划词 |
| --- | --- | --- |
| ![编辑与扩选](docs/screenshot-edit.png) | ![侧栏](docs/screenshot-sidebar.png) | ![网页](docs/screenshot-webpage.png) |
